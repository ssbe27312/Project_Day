...
public class focus_13_17_3 : MonoBehaviour //17hz에 책이 뜬 경우
{
    ...
    float p_13 = 0.0f; //각 초 마다 불러오는 13hz 값
    float p_17 = 0.0f; //각 초 마다 불러오는 17hz 값
    ...
    IEnumerator ReadFile()
    {
        ...
        else if (ssvep_state == 1)
        {
            ...
            fs_cnt2.Close();
            if (call_cnt == 5)
                SceneManager.LoadScene("15_Restart_OR_Studying"); //게임 실패 씬으로 변경 필요
            else
